                    ...
                    <div class="portlet light form-fit bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-green bold uppercase">Sửa thông tin thuốc</span>
                            </div>
                        </div>
                        <div class="portlet-body form">
                            ...
                            @endif
                            <form action="admin/QuanLyThuoc/sua/{{$benhnhan->id}}" method="POST" class="form-horizontal form-bordered" enctype="multipart/form-data">
