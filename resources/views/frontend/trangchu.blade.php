...
<body>
      ...
      <div class="container">
        <div class="navbar-header">
          <div class="navbar-brand">
            <a href="trangchu"><h1>Bệnh viện nha khoa Hà Nội</h1></a>
          </div>
        </div>
  ...
  <div class="gallery">
    ...
    <div class="container">
      <div class="col-md-4">
        <figure class="effect-marley">
          <img src="pages/img/8.jpg" alt="" class="img-responsive" />
          <figcaption>
            <h4>sweet marley</h4>
      ...
      <div class="col-md-4">
        <figure class="effect-marley">
          <img src="pages/img/9.jpg" alt="" class="img-responsive" />
          <figcaption>
            <h4>sweet marley</h4>
            <p>Marley tried to convince her but she was not interested.</p>
          </figcaption>
      ...
      <div class="col-md-4">
        <figure class="effect-marley">
          <img src="pages/img/10.jpg" alt="" class="img-responsive" />
          <figcaption>
            <h4>sweet marley</h4>
            <p>Marley tried to convince her but she was not interested.</p>
          </figcaption>
    ...
    <div class="container">
      <div class="col-md-4">
        <figure class="effect-marley">
          <img src="pages/img/11.jpg" alt="" class="img-responsive" />
          <figcaption>
            <h4>sweet marley</h4>
            <p>Marley tried to convince her but she was not interested.</p>
          </figcaption>
      ...
      <div class="col-md-4">
        <figure class="effect-marley">
          <img src="pages/img/12.jpg" alt="" class="img-responsive" />
          <figcaption>
            <h4>sweet marley</h4>
            <p>Marley tried to convince her but she was not interested.</p>
          </figcaption>
      ...
      <div class="col-md-4">
        <figure class="effect-marley">
          <img src="pages/img/13.jpg" alt="" class="img-responsive" />
          <figcaption>
            <h4>sweet marley</h4>
            <p>Marley tried to convince her but she was not interested.</p>
          </figcaption>
